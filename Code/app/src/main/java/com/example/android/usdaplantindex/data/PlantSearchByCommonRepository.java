...
public class PlantSearchByCommonRepository {

    private static final String TAG = PlantSearchByCommonRepository.class.getSimpleName();
    ...
    /*
     ...
     - When search box text changes, we iterate the pre-loaded array and for Common_Name that
    ...
    public PlantSearchByCommonRepository() {
    ...
    public void loadPlantNames() {
        ...
        String url = USDAPlantUtils.buildPlantSearchURL(
                LITE_LOAD_LIMIT, mLiteLoadOffset, "fields", "id,Common_Name");
